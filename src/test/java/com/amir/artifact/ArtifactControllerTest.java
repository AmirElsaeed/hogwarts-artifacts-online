...
class ArtifactControllerTest {
	...
	void testFindArtifactByIdNotFound() throws Exception {
		// Given
		given(this.artifactService.findById("1250808601744904190")).willThrow(new ObjectNotFoundException("artifact", "1250808601744904190"));
		
		// When and Then
		this.mockMvc.perform(get(this.baseUrl + "/artifacts/1250808601744904190").accept(MediaType.APPLICATION_JSON))
	...
	void testFindAllArtifactsSuccess() throws Exception {
		...
		.andExpect(jsonPath("$.data[5].id").value("1250808601744904196"))
		.andExpect(jsonPath("$.data[5].name").value("Resurrection Stone"));
	}
	...
	void testAddArtifactSuccess() throws Exception {
		...
		ArtifactDto artifactDto = new ArtifactDto(null, "Remembrall",
												"It was a magical large morble-sized glass ball that contained smoke which turned red when it's owner has forgotton something.",
												"ImageUrl", null);
		...
		savedArtifact.setDescription("It was a magical large morble-sized glass ball that contained smoke which turned red when it's owner has forgotton something.");
	...
	void testDeleteArtifactErrorWithNonExistentId() throws Exception {
		// Given
		doThrow(new ObjectNotFoundException("artifact", "1250808601744904192"))
