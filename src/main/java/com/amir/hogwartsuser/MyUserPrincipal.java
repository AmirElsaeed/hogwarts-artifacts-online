...
public class MyUserPrincipal implements UserDetails {
	...
	public Collection<? extends GrantedAuthority> getAuthorities() {
		// convert a user's role from comma-delimited string to a list of SimpleGrantedAuthority
		// and concat ROLE_ before role name "this will be same as role name in SecurityConfiguration class"
