...
class ArtifactControllerTest {
	...
	void testFindArtifactByIdNotFound() throws Exception {
		// Given
		given(this.artifactService.findById("1250808601744904190")).willThrow(new ArtifactNotFoundException("1250808601744904190"));
		
		// When and Then
		this.mockMvc.perform(get("/api/v1/artifacts/1250808601744904190").accept(MediaType.APPLICATION_JSON))
	...
	void testDeleteArtifactErrorWithNonExistentId() throws Exception {
		// Given
		doThrow(new ArtifactNotFoundException("1250808601744904192"))
